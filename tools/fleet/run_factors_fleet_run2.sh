...
set -u
REPO="${REPO:-c:/tmp/temari_factors_2026-08-16/repo2}"
TOOL="$REPO/src/gen_factors.jl"
OUT="${OUT:-c:/Users/seto/source/repos/Temari/src/prod_factors_v1_run2}"
BASE="${BASE:-c:/tmp/temari_factors_2026-08-16/run2}"
LANES="${LANES:-8}"
