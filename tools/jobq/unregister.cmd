...
rem ===========================================================================
rem  jobq unregister.cmd - double-click this to REMOVE this PC from the queue.
...
rem
rem  usage: unregister.cmd [-DryRun]
rem         (-Remove is added automatically; extra arguments are passed
rem          straight through to bootstrap.ps1)
...
echo   extra args  : -Remove%JOBQ_EXTRA%
echo.
powershell -NoProfile -ExecutionPolicy Bypass -File "%JOBQ_BOOTSTRAP%" -Root "%JOBQ_HERE%" -User "%JOBQ_USER%" -Remove%JOBQ_EXTRA%
