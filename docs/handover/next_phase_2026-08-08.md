...
*前回の引き継ぎは `docs/handover/next_phase_2026-08-07.md` (その §2 / §3 / §5.2 / §5.5 は実施済)。
本書はそこからの差分と、**リリースに向けて残っている作業**。
**冒頭でこれを読み、次に `docs/notes/release_readiness_2026-08-07.md` を読むこと。***
...
1. **v3 出荷データには欠陥がある** — 連続状態の SRC が F(s) を 1.5〜6 %、L1 では
   数十 % ずらす。**機構まで特定済**。正本 = `docs/notes/src_defect_2026-08-07.md`
...
`docs/notes/speedup_audit_2026-08-05.json` の未検証 16 案と、
...
- F(s) vs Oxley–Allen / µSTEM (`docs/notes/fs_external_validation_2026-08-07.md` の手順)
- GOS vs Zhang DB (`docs/notes/kappa_dirac_continuum_2026-08-07.md`)
...
- 未検証の高速化 16 案 (`docs/notes/speedup_audit_2026-08-05.json` の verdict 無し項目)。
...
1. **`docs/notes/release_readiness_2026-08-07.md`** — M 殻・σ の実験照合・交換処方の判断
2. **`docs/notes/src_defect_2026-08-07.md`** — SRC の欠陥。**v4 に切り替える理由そのもの**
3. `docs/notes/kappa_dirac_continuum_2026-08-07.md` — v4 の連続状態。コストもここ
4. `docs/notes/fs_external_validation_2026-08-07.md` — F(s) の外部照合と物差しの選び方
5. `docs/notes/frozen_core_and_transverse_2026-08-07.md` — frozen core と横断項
6. `docs/notes/mott_elastic_2026-08-07.md` — P4
7. `docs/notes/exchange_diagnosis_2026-08-07.md` — 交換の診断 (KLI の実装根拠)
