...
*前回は `docs/next_phase_2026-08-10.md`（s グリッド 16 Å⁻¹ への延長計画）。
その **§2 のゲートは全項目完了、§3 の Temari 側実装も完了**し、
**本番生成が走っている最中**でこの引き継ぎを書いている。*

***⚠ 冒頭でこれと `docs/tail_contract_2026-08-09.md` §4「主張してはならないこと」を読むこと。***
...
正本 = **`docs/basis_s_requirement_2026-08-10.md`**。`AlchemiCheck basis` を新設して測った。
...
- **CLAUDE.md の更新**（現在地を v5 へ、`docs/next_phase_2026-08-11.md` を正本に）
