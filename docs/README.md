...
| [`certification_v4_preregistration_2026-08-20.md`](notes/certification_v4_preregistration_2026-08-20.md) | Preregistration of candidate v4 — v3's windows with the partial-wave rule taken from src (`:src` = LKIN_RULE v6, cap 256) so F(s) and σ(β,Δ) share one prescription; n_q stays 1216. Not yet run. |
