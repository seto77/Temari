# dataset v6 — errata (2026-08-29)

⚠ 本書は出荷済み/生成済み dataset v6 の**隣に置く注記**で、データにも MANIFEST にも触れていない。
...
**作者決定 (2026-08-29): dataset v6 は「点核の表」と定義し直す** (数値・checksum は不変)。有限核は次世代の別 `model_id`。
