...
| **260808Cl の高速化 6 点** (RK4 の pot_V 共有 / Q₊ の ε ごと 1 回化 / Legendre 漸化のインターリーブ / ε ループの `:greedy`+LPT / **E5 q レーンの Dirac 版への移植** / BLAS 1 スレッド) | 高速化 (ビット同一、計 3.9 倍) | **v4 と同時**。正本 = `docs/notes/speedup_v4_2026-08-08.md` |
